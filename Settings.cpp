#include "Settings.h"
 ...
 std::vector<int> StandartNeiron1 = {7, 8, 8, 8, 1}, StandartNeiron2 = {6, 8, 8, 8, 2};
 double kEnergyGrow = 0.1, kMutate = 0.5, kPhotosintes = 100, kPredotor = 100, kGo = 0.1, deltMutate = 2, kMultiply = 1000;
 int kFind = 2, kEnemy = 20;
int WorldWidth = 1600, WorldHeight = 1000;
